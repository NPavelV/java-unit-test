...
public void checkIsAdultWhenAgeIsLessThan18False(){
    ...
    assertEquals("Должно вернуться false, так как пользователь несовершанолетний", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True(){
    ...
    assertEquals("Должно вернуться true, если пользователю 18 лет", true, isAdult);
}
